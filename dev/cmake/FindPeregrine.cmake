...
MESSAGE( STATUS "Dev Builds: $ENV{DEV_BUILDS}")

IF ( WIN32 )
set( LIBRARY_OUTPUT_PATH $ENV{DEV_BUILDS} )
set( EXECUTABLE_OUTPUT_PATH $ENV{DEV_BUILDS} )
ELSE ( WIN32 )
set( LIBRARY_OUTPUT_PATH $ENV{DEV_BUILDS} )
set( EXECUTABLE_OUTPUT_PATH $ENV{DEV_BUILDS} )
ENDIF ( WIN32 )
...
IF ( WIN32 )
#windows defines min/max in WinDefs.h that end up conflicting with std::min/max - we prefer std::min/max thus tell the compiler to avoid the defines
