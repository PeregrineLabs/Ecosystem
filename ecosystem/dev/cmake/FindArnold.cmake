...
SET ( MTOA_INCLUDE_SUBDIR "")

FIND_PATH ( MTOA_BASE_DIR include/extension/Extension.h
  ENV MTOA
  )

IF ( NOT MTOA_BASE_DIR )
SET ( MTOA_INCLUDE_SUBDIR "/mtoa")
FIND_PATH ( MTOA_BASE_DIR include${MTOA_INCLUDE_SUBDIR}/extension/Extension.h
  ENV MTOA
  )
ENDIF ( NOT MTOA_BASE_DIR )

IF ( MTOA_BASE_DIR )
	MESSAGE(STATUS "Found MTOA: ${MTOA_BASE_DIR}")
  	SET ( MTOA_LIBS mtoa_api )
  	SET ( MTOA_INCLUDE_DIRS ${MTOA_BASE_DIR}/include/${MTOA_INCLUDE_SUBDIR}
